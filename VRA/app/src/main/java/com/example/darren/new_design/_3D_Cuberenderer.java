...
public class _3D_Cuberenderer implements GLSurfaceView.Renderer
{
	/**
...
//	float touchedY = 0;
	...
	final FloatBuffer mcubeVertices;
	...
	int mTextureDataHandle0;
	int mTextureDataHandle1;
	int mTextureDataHandle2;
	int mTextureDataHandle3;
	int mTextureDataHandle4;
	int mTextureDataHandle5;
	 ...
	 */
	public _3D_Cuberenderer(_3D_Cubesurfaceview cubesurfaceview)
	{
