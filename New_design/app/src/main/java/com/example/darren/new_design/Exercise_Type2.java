...
public class Exercise_Type2 extends Fragment {

    ImageView left_point, right_point;
    String Colour;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View InputFragmentView = inflater.inflate(R.layout.exercise_type_2, container, false);


        left_point = (ImageView) InputFragmentView.findViewById(R.id.left_point);
        right_point = (ImageView) InputFragmentView.findViewById(R.id.right_point);
    ...
    public void setColour( String colour ){
        ...
        //CharSequence text = "Set Colour - 2";
